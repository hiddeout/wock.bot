...
from tools.important.services.TikTok import TikTokClient, User, UserFeed, Video # type: ignore
from typing import Optional, Union, Tuple, Any # type: ignore
...
class MediaHandler:
    def __init__(self: Self, bot: AutoShardedBot):
        self.bot = bot
        self._tiktok = TikTokClient(["M0ZhoJVNBUzMsS6kaMGSMblq1qLxJLdK1iSzkK8wX5-F7T77f7J_B6LIfEUXGREuhv75wfVZRh9nPHtFZWJp5EECoilXuhF5xaiIqAFQhhM="], 1, 5)
