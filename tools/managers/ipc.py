...
class IPC:
    ...
    async def start(self: Self) -> bool:
        ...
        routes: List[Coroutine] = [
            ...
            if callable(getattr(self, method_name)) and method_name not in excluded_methods
        ]
